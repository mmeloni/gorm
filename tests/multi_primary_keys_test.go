...
func _TestManyToManyWithMultiPrimaryKeys(t *testing.T) {
	var cl = func() {}
	var err error
	var db *gorm.DB
...
func _TestManyToManyWithCustomizedForeignKeys(t *testing.T) {
	var cl = func() {}
	var err error
	var db *gorm.DB
	if os.Getenv("GORM_DIALECT") == "immudb"{
...
func _TestManyToManyWithCustomizedForeignKeys2(t *testing.T) {
	var cl = func() {}
	var err error
	var db *gorm.DB
	if os.Getenv("GORM_DIALECT") == "immudb"{
...
func _TestCompositePrimaryKeysAssociations(t *testing.T) {
	var cl = func() {}
	var err error
	var db *gorm.DB
	if os.Getenv("GORM_DIALECT") == "immudb"{
